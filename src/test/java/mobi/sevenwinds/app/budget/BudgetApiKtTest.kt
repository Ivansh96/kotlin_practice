    ...
    fun testStatsSortOrder() {
        ...
        RestAssured.given()
            ...
            .toResponse<BudgetYearStatsResponse>().let { response ->
                ...
                Assertions.assertEquals(100, response.items[0].amount)
                Assertions.assertEquals(5, response.items[1].amount)
                Assertions.assertEquals(50, response.items[2].amount)
                Assertions.assertEquals(30, response.items[3].amount)
                Assertions.assertEquals(400, response.items[4].amount)
            }
    }
